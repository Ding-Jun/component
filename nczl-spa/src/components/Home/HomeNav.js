    ...
    return (
      <div className="home-nav">
        <Nav>
          ...
          <NavItem><Link to="user/preview"><img src={lt22}/>用户管理</Link></NavItem>
          <NavItem><Link to="message/preview"><img src={lt22}/>短信推送</Link></NavItem>
          <NavItem><Link to="admin/preview"><img src={lt22}/>管理员管理</Link></NavItem>
        </Nav>
      </div>
    )
  }
