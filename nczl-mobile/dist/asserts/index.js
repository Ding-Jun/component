...
/***/ function(module, exports, __webpack_require__) {
	...
	var _urlEncode = __webpack_require__(152);
	...
	function showSliderPictureList() {
	  ...
	  var url = _constants.root + '/rs/article/list?curPage=' + targetPage + '&pageSize=10';
	  $.ajax({
	    type: 'GET',
	    url: url,
	    dataType: 'json',
	    success: function success(rm) {
	      if (rm.code == 1) {
	...
	function doShowSliderPictureList(articles) {
	  var articleList = (0, _map2.default)(articles, function (article) {
	    return ['<a href="article.html">', '<div class="news">', '<img src="images/pic2.jpg" class="newspic">', '<h2>\u8D85\u8D8A\u4F20\u7EDF\u4E92\u8054 \u5065\u5EB7\u4E2D\u56FD\u6B65\u5165\u5927\u6570\u636E\u65F6\u4EE3</h2>', '<h5><span><img src="images/icon_like.png" width="22"> 23433</span> \u6C88\u67D0\u67D0  \u5728\u7EBF\u62A4\u7406\u5BA3\u6559\u6F14\u793A\u53C2\u4E0E\u533B\u9662\u62A4\u58EB\u957F</h5>', '</div></a>'].join('');
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(119),
	    ...
	    baseGetTag = __webpack_require__(123),
	    toSource = __webpack_require__(66);
...
/***/ function(module, exports) {
	 ...
	 * Created by admin on 2016/10/27.
	 */
	var root = exports.root = '/nczl-web';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.doShowArticleList = exports.showArticleList = undefined;
	...
	//import $ from 'jquery'
	var showArticleList = exports.showArticleList = function showArticleList(targetPage, query) {
	  var queryString = (0, _urlEncode2.default)(query);
	  var url = _constants.root + '/rs/article/list?curPage=' + targetPage + '&pageSize=10' + queryString;
	  $.ajax({
	    type: 'GET',
	    url: url,
	    dataType: 'json',
	    ...
	    */
	//===============Show Articles=======================
	var doShowArticleList = exports.doShowArticleList = function doShowArticleList(articles) {
	  var articleList = (0, _map2.default)(articles, function (article) {
	    return ['<a href="article.html?id=' + article.id + '">', '<div class="news">', '<img src="' + article.titleImg + '" class="newspic">', '<h2>' + article.title + '</h2>', '<h5><span><img src=\'images/icon_like.png\' width="22"> ' + article.likes + '</span> ' + article.author + '  </h5>', '</div></a>'].join('');
	  });
	  //console.log("articleList",articleList);
	  $('.article-loading').before(articleList.join(''));
	};
